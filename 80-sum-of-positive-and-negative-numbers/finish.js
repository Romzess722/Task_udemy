...
// }
//---------------------------------------------
// const result = numbers.reduce((sums, num) => {
//   num > 0 
//   ? {...sums, positive: sums.positive += num}
//   : {...sums, negative: sums.negative += num}
//     return sums

// }, { positive: 0, negative: 0, url: false});

// return result;

const sumPositiveNegative = (numbers) => {
  return numbers.reduce((sums, num) =>
    num > 0
    ? {...sums, positive: sums.positive + num}
    : {...sums, negative: sums.negative + num}
